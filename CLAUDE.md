...
- **The layout link is never rendered in the message.** It's stored in `base_posts.link` and handed out only as an ephemeral reply to the "🔗 Fetch Link" button. Don't add it to the embed, the content, or the confirmation reply.
